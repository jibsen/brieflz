...
lcmglobal is_crc32_asm_fast,8

lcmexport is_crc32_asm_fast,8
...
lcmlabel is_crc32_asm_fast,8
    ; is_crc32_asm_fast(const void *source,
    ;                   unsigned int length);
...
%ifdef _OBJ_
    mov    edi, is_crctab_b wrt FLAT ; edi -> crctab
%else
    mov    edi, is_crctab_b   ; edi -> crctab
%endif
...
is_crctab_b dd 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419
