...
global _blz_workmem_size
global _blz_max_packed_size
global _blz_pack

; =============================================================

_blz_workmem_size:
    ; blz_workmem_size(unsigned short length);
...
_blz_max_packed_size:
    ; blz_max_packed_size(unsigned short length);
...
_blz_pack:
    ; blz_pack(const void far *source,
